...
export async function POST(req: Request) {
  try {
    ...
    const prompt = `You are an AI HR Assistant reporting to a Senior Leader. Based on the following employee data, write a concise, realistic executive summary of their performance today. Point out any potential blockers or areas needing support. Use markdown formatting to make the summary readable and structured. Do not address the employee directly, address the manager.
