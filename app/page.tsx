    ...
    <div style={{ background: "var(--bg-canvas)", color: "var(--ink)", minHeight: "100vh" }}>
      ...
      <nav className={scrolled ? "apple-glass" : ""} style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div className="metallic-bg" style={{ width: 34, height: 34, borderRadius: 10, display: "grid", placeItems: "center", color: "#fff", fontWeight: 800, fontSize: 16 }}>
            ✨
          </div>
      ...
      <motion.section initial="hidden" animate="show" variants={stagger} style={{
        ...
        <motion.div variants={fadeUp} style={{ background: "var(--brand-color-light)", borderRadius: 14, padding: "8px 20px", fontSize: 13, fontWeight: 600, color: "var(--brand-color)", marginBottom: 24, display: "inline-flex", gap: 8, alignItems: "center" }}>
